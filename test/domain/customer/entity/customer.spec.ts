...
import SendConsoleLog1WhenCustomerIsCreatedHandler from "../../../../src/domain/customer/event/handler/send-console-log-1-when-customer-is-created.handler";
import SendConsoleLog2WhenCustomerIsCreatedHandler from "../../../../src/domain/customer/event/handler/send-console-log-2-when-customer-is-created.handler";
import SendConsoleLogWhenCustomerAddressIsChangedHandler from "../../../../src/domain/customer/event/handler/send-console-log-when-customer-address-is-changed.handler";
